...
export const ActiveCasesPage = () => {
  ...
  const { data: casesData, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await authApi.getCases(user.id);
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Track and manage your ongoing legal cases</p>
          </div>
        </div>
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No cases reported</h3>
          <p className="text-gray-500">You haven't reported any cases yet. Would you like to report a new case?</p>
          <button
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {cases.map((caseItem) => (
          <CaseCard
            ...
            lawyer={caseItem.lawyer && { name: caseItem.lawyer }}
